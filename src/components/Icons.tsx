...
import { FileText, ClipboardCheck, Pen, BarChart2, KanbanSquare, ChartBar } from "lucide-react";
...
export const KanbanBoard = KanbanSquare;
export const ChartFinance = ChartBar;
